...
public final class Constants {
  public static final class DriveConstants {
    public static final double ksVolts = 0.472;
    public static final double kvVoltSecondsPerMeter = 9.96;
    public static final double kaVoltSecondsSquaredPerMeter = 0.041;
